...
class Application:
    ...
    def search_db(self):
        ...
        self.update = Button(self.master, text="Update?", width=20, height=2,fg='white', bg='Green' , command=self.update_db)
        self.update.place(x=400, y=410)

        # button to delete
        self.delete = Button(self.master, text="Delete?", width=20, height=2,fg='white', bg='red', command=self.delete_db)
