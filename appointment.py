...
class Application:
    def __init__(self, master):
        ...
        self.right = Frame(master, width=600, height=720, bg='lightgreen')
        self.right.pack(side=RIGHT)

        # labels for the window
        self.heading = Label(self.left, text="Car Booking", font=(
            'georgia 40 bold'), fg='white', bg='blue')
        self.heading.place(x=0, y=0)
        # patients name
        self.name = Label(self.left, text="Owner's Name", font=(
            'georgia 18 bold'), fg='white', bg='deeppink')
        ...
        self.submit = Button(self.left, text="Add Booking", width=20,
                             height=2, bg='green', fg='white', command=self.add_appointment)
        ...
        self.logs = Label(self.right, text="Booking logs", font=(
            'georgia 28 bold'), fg='white', bg='blue')
